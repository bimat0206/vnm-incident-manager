# ==============================================================================
# VNM AWS Health On-Call Notification System - Contact Creation Script
# Purpose:
# This script allows administrators to define and create/update on-call contacts
# in AWS Systems Manager Incident Manager.
#
# Version: 2.1 - Contacts Only
# Date: 2025-06-26
# ==============================================================================
...
CONTACTS_DEFINITION = {
    "lmhung": {
        "name": "L M Hung",
        "channels": [
            {"type": "EMAIL", "address": "asda1111sd@gmail.com", "engagement_time_minutes": 15},
            {"type": "SMS", "address": "+84984001304", "engagement_time_minutes": 15},
        ]
    },
    "dnkhanh": {
        "name": "D N Khanh",
        "channels": [
            {"type": "EMAIL", "address": "as456341sd@gmail.com", "engagement_time_minutes": 15},
            {"type": "SMS", "address": "+84329097011", "engagement_time_minutes": 15},
        ]
    },
    "ntquy": {
        "name": "N T Quy",
        "channels": [
            {"type": "EMAIL", "address": "amamnasd1sd@gmail.com", "engagement_time_minutes": 15},
            {"type": "SMS", "address": "+84934198214", "engagement_time_minutes": 15},
        ]
    },
    "dvcong": {
        "name": "D V Cong",
        "channels": [
            {"type": "EMAIL", "address": "asaa41111sd@gmail.com", "engagement_time_minutes": 10},
            {"type": "SMS", "address": "+84344353129", "engagement_time_minutes": 15},
        ]
    },
...
def main():
    ...
    print("Starting AWS Incident Manager Contact Creation Script...")
    print(f"Version: 2.1 - Contacts Only")
    ...
    helper.log("\n--- Processing Contact Definitions ---")
    for alias, details in CONTACTS_DEFINITION.items():
        try:
